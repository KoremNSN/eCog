...
sub_cats = ['hosuehold', 'heights', 'needles']
...
Trauma = ['In the current task, you will listen to a narrative of the traumatic experience you told us about.'
...
# %% Methods for the Recall Experiment
    ...
    def Pic_recall(self , cats = sub_cats):
        ...
        random.shuffle(cats)
        blocks = ['Recall pictures from category ' + cats[0], 'Recall pictures from category ' + cats[1], 'Recall pictures from category '  + cats[2]]
...
# %% Method to play audio reminders
    def audio_reminders(self):
        ...
        # Combine to 1 list
        sounds = Neutral_audio + Trauma_audio
...
# %% menu
    ...
    def menu(self):
        ...
        while buttonPress != '6':
            self.Text.pos = (0,0)
            self.Text.text = " 1. Script unrelated.\n 2. Script negative .\n 3. Script positive .\n 4. Visual task     .\n 5. Auditory task   .\n 6. End exp         ."
            self.Text.draw()
            self.win.flip()
            ...
            if buttonPress == ['1']:
                ...
                self.text_display(Trauma) # Display trauma script instructions
                self.script(sound_file = 'trauma') # Run trauma script
            elif buttonPress == ['3']:
